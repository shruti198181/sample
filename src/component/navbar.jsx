...
function Mynavbar () {
    ...
    return (
        ...
        <Navbar expand = "lg" fixed="top" className="w-100"style={{ backgroundColor: "rgba(255, 99, 71, 0.2)" }}>
                ...
                placement="end">
                    ...
                    <Offcanvas.Body>
                        <Nav className="justify-content-center flex-grow-1 pe-3 ">
                            <NavLink className="me-3" as={NavLink} to="/" style={{textDecoration:'none'}}>Home</NavLink>
                            <NavLink  className="me-3" as={NavLink} to="/" style={{textDecoration:'none'}}>About</NavLink>
                            <NavLink className="me-3" as={NavLink} to="/" style={{textDecoration:'none'}}>Product</NavLink>
                            <NavLink className="me-3" as={NavLink} to="/" style={{textDecoration:'none'}}>Contact</NavLink>
                            <NavLink className="me-3" as={NavLink} to="/" style={{textDecoration:'none'}}>Service</NavLink>
                        </Nav>
                        <Form className="me-5">
                          <FormControl 
                          type="search"
